...
export type InitialStateType = {
    ...
    alldealerOrderLedger: LedgerListResponse[] | []
    totalItems: number
...
const dealerOrderLedgerSlice: any = createSlice({
    name: 'dealersLedger',
    initialState,
    reducers: {
        ...
        setSelectedDealerOrderLedgerId: (
            state,
        ...
        setAllDealerOrderLedger: (
            state,
            action: PayloadAction<LedgerListResponse[] | []>
        ) => {
            state.alldealerOrderLedger = action.payload
        },
...
export const {
    ...
    setAllDealerOrderLedger,
    setFilterBy,
} = dealerOrderLedgerSlice.actions
export default dealerOrderLedgerSlice.reducer
