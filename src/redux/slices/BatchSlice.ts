...
export type InitialStateType = {
    ...
    selectedItem: BatchListResponse | null
    totalItems: number
...
const batchSlice: any = createSlice({
    name: 'asr',
    initialState,
    reducers: {
        setItems: (state, action: PayloadAction<BatchListResponse[] | []>) => {
        ...
        setSelectedItem: (
            state,
            action: PayloadAction<BatchListResponse | null>
        ) => {
